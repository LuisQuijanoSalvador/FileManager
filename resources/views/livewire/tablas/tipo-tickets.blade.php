<div>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="py-1">
                    <div class="btn-group text-end" role="group" aria-label="Botones de accion">
                        <button type="button" class="btn btn-outline-primary mr-2 rounded" data-bs-toggle="modal" data-bs-target="#FormularioModal" wire:click='editar("{{$tipoTicket->id}}")'>Editar</button>
                        <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal" data-bs-target="#ModalEliminacion" wire:click='encontrar("{{$tipoTicket->id}}")'>Eliminar</button>
                    </div>
                </td>
            </tr>
            @endforeach
    ...
    @include('components.modalheader')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="txtDescripcion" autofocus wire:model.lazy="descripcion" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
            @error('descripcion')
