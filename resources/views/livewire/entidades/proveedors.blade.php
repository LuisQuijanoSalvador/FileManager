            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="py-1">
                    <div class="btn-group text-end" role="group" aria-label="Botones de accion">
                        <button type="button" class="btn btn-outline-primary mr-2 rounded" data-bs-toggle="modal" data-bs-target="#FormularioModal" wire:click='editar("{{$proveedor->id}}")'>Editar</button>
                        <button type="button" class="btn btn-danger rounded" data-bs-toggle="modal" data-bs-target="#ModalEliminacion" wire:click='encontrar("{{$proveedor->id}}")'>Eliminar</button>
                    </div>
                </td>
            </tr>
            @endforeach
                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" wire:model.lazy="esConsolidador">
                                <label class="form-check-label" for="flexSwitchCheckDefault">Es Consolidador</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label for="txtComision" class="form-label">Comisión:</label>
                            <input type="number" class="form-control" id="txtComision" wire:model.lazy="comision">
                            @error('comision')
                                <span class="error">{{$message}}</span>
                            @enderror
                        </div>
