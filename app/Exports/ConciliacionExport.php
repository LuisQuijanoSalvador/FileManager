...
class ConciliacionExport implements FromView, WithStyles
{
    ...
    {
        return view('exports.reportes.conciliacion', [
            'ventas' => DB::select('CALL get_conciliacion_fechas(?, ?)', [$this->fechaInicio, $this->fechaFin])
        ]);
    }
